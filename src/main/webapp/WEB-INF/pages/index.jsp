...
<head>
    ...
    <title style="margin-right: auto">SpringMVC Demo 首页</title>
    ...
    <link href="/bootstrap-3.3.5/docs/examples/dashboard/dashboard.css" rel="stylesheet">
    ...
    <script src="/bootstrap-3.3.5/docs/assets/js/vendor/holder.min.js"></script>
